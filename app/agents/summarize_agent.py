...
AI agent for generating flight summaries and insights using existing FlightDetails model.
"""
...
summarize_agent = Agent[SummarizeDeps, FlightSummary](
    llm_model,
    result_type=FlightSummary,
    usage_limits=UsageLimits(request_limit=5, token_limit=8000),
    system_prompt="""
